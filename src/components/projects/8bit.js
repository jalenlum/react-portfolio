  ...
  return (
    <div className="card h-100 text-white" style={{ backgroundColor: "#282828" }}>
      ...
      <div className="card-body">
        <h4 className="card-title">8bit</h4>
        <div className="card-subtitle mb-4"><h6>February 2024 - Present</h6></div>
        <div className="card-text">
          A university solutions organization that provides software solution services to local businesses and on-campus university departments.
        </div>
        ...
        <div className="modal fade modal-xl text-black" id="bit">
          <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div className="modal-content text-white" style={{ backgroundColor: "#282828" }}>
              <div className="modal-header" style={{ borderColor: "#282828" }}>
                <h1>8bit (8 Business Information & Technology)
                  <h6 style={{ color: "#d3d3d3" }}>
                    February 2024 - Present
                    <h6>A university organization that provides software solution services to local businesses and on-campus university departments.
