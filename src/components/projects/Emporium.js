...
export const Emporium = () => {
  return (
    <div className="card h-100 text-white" style={{ backgroundColor: "#282828" }}>
      <img className="card-img-top" src="../../../assets/placeholder.png" alt="Project"></img>
      <div className="card-body">
        <h4 className="card-title">Tutor Schedules Page</h4>
        <div className="card-subtitle mb-4"><h6>February 2024 - Present</h6></div>
        <div className="card-text">
         A responsive web application that serves as a weightlifting calculator
        </div>

        <button
          className="btn text-white mt-4"
          data-bs-toggle="modal"
          data-bs-target="#lifte"
          style={{ backgroundColor: "#1e1e1e", borderRadius: 60 }}>
          Read More
        </button>

        <div className="modal fade modal-xl text-black" id="lifte">
                ...
                <h1>Lifte
                  <h6 style={{ color: "#d3d3d3" }}>
                    ...
                    <h6>A comprehensive showcase of all my accomplishments on a full-stack website
                      ...
                      <a className="text-white" href="https://genuine-kangaroo-3280cb.netlify.app/" target="_blank"><i class="fa-solid fa-link"></i> www.lifte.pro</a>
                    </h6>
                  </h6>
                </h1>
